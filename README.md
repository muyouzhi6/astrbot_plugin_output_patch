...
_✨ 自用 AstrBot 输出链路补丁 ✨_

[![License](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
[![Python 3.10+](https://img.shields.io/badge/Python-3.10%2B-blue.svg)](https://www.python.org/)
[![AstrBot](https://img.shields.io/badge/AstrBot-3.4%2B-orange.svg)](https://github.com/Soulter/AstrBot)
[![GitHub](https://img.shields.io/badge/作者-muyouzhi6-blue)](https://github.com/muyouzhi6)
...
输出补丁基于 OutputPro fork 维护, 作为自用 AstrBot 输出链路补丁包使用. 它作用于 AstrBot **发送前**的“最后一公里”，把一条消息从原始文本到最终呈现拆成 12 个可独立开关的阶梯。
